...
本版本为由 **JN** 开发的分支版本。在原有项目基础上继续开发并维护，新增功能与修改内容以本分支实际代码为准。
## 状态机
...
- 类型：冒险标签页中的隐藏挑战进度。
- 图标：望远镜。
- 达成条件：玩家使用望远镜连续两次观察名为 `maodie` 的耄耋。
- 达成后：进度会在冒险标签页中显示，弹出提示，并在聊天栏播报。
...
- 类型：冒险标签页中的非隐藏挑战进度。
- 图标：纸筒。
- 达成条件：击杀名为 `maodie` 的耄耋。
- 达成后：弹出挑战进度提示，并在聊天栏播报。
